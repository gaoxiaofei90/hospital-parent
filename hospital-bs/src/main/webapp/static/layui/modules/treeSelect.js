            ...
            init: function(){
                layui.util.ajax({
                    ...
                    success: function (res) {
                        var list=[];
                        var id='id';
                        if(res.respData instanceof Array){
                            list=res.respData;
                        }else{
                            if(res.respData.list.length>0){
                                list=res.respData.list;
                                if(list[0].postId!==undefined){
                                    id='postId';
                                }else if(list[0].roleId!==undefined){
                                    id='roleId';
                                }
                        ...
                        var treeData = new layui.util.TreeWapper(list,
                            id,'pid').toTree();
                        DATA = treeData;
                        ...
                        $.fn.zTree.init($('#' + TREE_SELECT_BODY_ID), a.setting(), treeData);
                        if (search) {
                            a.searchParam();
                        }
                        if (success){
