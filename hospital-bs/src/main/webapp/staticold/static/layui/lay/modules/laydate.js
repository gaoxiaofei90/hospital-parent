...
;!function(){
  ...
  */
  ...
  Class.prototype.calendar = function(value){
    ...
    if (!that.config.max || isNaN(that.config.max.month) || !that.config.max.month){
        that.config.max = {date: 30,hours: 0,minutes: 0,month: 12,seconds: 0,year: 2099};
    }
    if (!that.config.min || isNaN(that.config.min.month) || !that.config.min.month){
        that.config.min = {date: 1,hours: 0,minutes: 0,month: 0,seconds: 0,year: 1900};
    }
